        ...
        <fieldset>
          ...
          <ol>
            <li>
              ...
              <input type="text" name="nombre" id="nombre" autofocus placeholder="Last, First" required>
            </li>
            <li>
            ...
            <li>
              ...
              <input type="email" name="correo" id="correo" required autocomplete="off">
            </li>
            <li>
          ...
          <?php
            if (isset($_GET["nombre"])){
              ...
              $nombre = $_GET["nombre"];
              $correo = $_GET["correo"];
              $consulta = "INSERT INTO datos VALUES (NULL,'$nombre', '$correo')";
